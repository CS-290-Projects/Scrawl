...
class SettingsFrame(ttk.Notebook):
    ...
    def create_variables(self):
        ...
        self.shorthand_s1.set('...')
        self.shorthand_s2.set('...')
        self.shorthand_s3.set('...')
        self.shorthand_s4.set('...')
        self.shorthand_s5.set('...')
        self.shorthand_s6.set('...')
        self.shorthand_s7.set('...')
        self.shorthand_s8.set('...')
        self.shorthand_s9.set('...')
        self.shorthand_s10.set('...')
        self.shorthand_s11.set('...')
        self.shorthand_s12.set('...')
        self.shorthand_s13.set('...')
        self.shorthand_s14.set('...')
        self.shorthand_s15.set('...')
        self.shorthand_s16.set('...')
        self.shorthand_s17.set('...')
        self.shorthand_s18.set('...')
        self.shorthand_s19.set('...')
        self.shorthand_s20.set('...')
        ...
        self.shorthand_w1.set('...')
        self.shorthand_w2.set('...')
        self.shorthand_w3.set('...')
        self.shorthand_w4.set('...')
        self.shorthand_w5.set('...')
        self.shorthand_w6.set('...')
        self.shorthand_w7.set('...')
        self.shorthand_w8.set('...')
        self.shorthand_w9.set('...')
        self.shorthand_w10.set('...')
        self.shorthand_w11.set('...')
        self.shorthand_w12.set('...')
        self.shorthand_w13.set('...')
        self.shorthand_w14.set('...')
        self.shorthand_w15.set('...')
        self.shorthand_w16.set('...')
        self.shorthand_w17.set('...')
        self.shorthand_w18.set('...')
        self.shorthand_w19.set('...')
        self.shorthand_w20.set('...')
    ...
    def create_widgets(self):
        ...
        self.gen_conflict_notifier = ttk.Label(self.general_tab, textvariable=self.conflict_notifier_var)
        ...
        self.shorthand_btn_1['command'] = lambda: self.change_shorthand(self.shorthand_entry_1, self.shorthand_s1, self.shorthand_btn_1, self.shorthand_s1_btn)
        self.autocomp_btn_1 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w1_btn)
        self.autocomp_btn_1['command'] = lambda: self.change_shorthand(self.autocomp_entry_1, self.shorthand_w1, self.autocomp_btn_1, self.shorthand_w1_btn)       
        ...
        self.shorthand_btn_2['command'] = lambda: self.change_shorthand(self.shorthand_entry_2, self.shorthand_s2, self.shorthand_btn_2, self.shorthand_s2_btn)
        self.autocomp_btn_2 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w2_btn)
        self.autocomp_btn_2['command'] = lambda: self.change_shorthand(self.autocomp_entry_2, self.shorthand_w2, self.autocomp_btn_2, self.shorthand_w2_btn)
        ...
        self.shorthand_btn_3['command'] = lambda: self.change_shorthand(self.shorthand_entry_3, self.shorthand_s3, self.shorthand_btn_3, self.shorthand_s3_btn)
        self.autocomp_btn_3 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w3_btn)
        self.autocomp_btn_3['command'] = lambda: self.change_shorthand(self.autocomp_entry_3, self.shorthand_w3, self.autocomp_btn_3, self.shorthand_w3_btn)
        ...
        self.shorthand_btn_4['command'] = lambda: self.change_shorthand(self.shorthand_entry_4, self.shorthand_s4, self.shorthand_btn_4, self.shorthand_s4_btn)
        self.autocomp_btn_4 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w4_btn)
        self.autocomp_btn_4['command'] = lambda: self.change_shorthand(self.autocomp_entry_4, self.shorthand_w4, self.autocomp_btn_4, self.shorthand_w4_btn)
        ...
        self.shorthand_btn_5['command'] = lambda: self.change_shorthand(self.shorthand_entry_5, self.shorthand_s5, self.shorthand_btn_5, self.shorthand_s5_btn)
        self.autocomp_btn_5 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w5_btn)
        self.autocomp_btn_5['command'] = lambda: self.change_shorthand(self.autocomp_entry_5, self.shorthand_w5, self.autocomp_btn_5, self.shorthand_w5_btn)
        ...
        self.shorthand_btn_6['command'] = lambda: self.change_shorthand(self.shorthand_entry_6, self.shorthand_s6, self.shorthand_btn_6, self.shorthand_s6_btn)
        self.autocomp_btn_6 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w6_btn)
        self.autocomp_btn_6['command'] = lambda: self.change_shorthand(self.autocomp_entry_6, self.shorthand_w6, self.autocomp_btn_6, self.shorthand_w6_btn)     
        ...
        self.shorthand_btn_7['command'] = lambda: self.change_shorthand(self.shorthand_entry_7, self.shorthand_s7, self.shorthand_btn_7, self.shorthand_s7_btn)
        self.autocomp_btn_7 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w7_btn) 
        self.autocomp_btn_7['command'] = lambda: self.change_shorthand(self.autocomp_entry_7, self.shorthand_w7, self.autocomp_btn_7, self.shorthand_w7_btn)
        ...
        self.shorthand_btn_8['command'] = lambda: self.change_shorthand(self.shorthand_entry_8, self.shorthand_s8, self.shorthand_btn_8, self.shorthand_s8_btn)
        self.autocomp_btn_8 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w8_btn) 
        self.autocomp_btn_8['command'] = lambda: self.change_shorthand(self.autocomp_entry_8, self.shorthand_w8, self.autocomp_btn_8, self.shorthand_w8_btn)
        ...
        self.shorthand_btn_9['command'] = lambda: self.change_shorthand(self.shorthand_entry_9, self.shorthand_s9, self.shorthand_btn_9, self.shorthand_s9_btn)
        self.autocomp_btn_9 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w9_btn)
        self.autocomp_btn_9['command'] = lambda: self.change_shorthand(self.autocomp_entry_9, self.shorthand_w9, self.autocomp_btn_9, self.shorthand_w9_btn)
        ...
        self.shorthand_btn_10['command'] = lambda: self.change_shorthand(self.shorthand_entry_10, self.shorthand_s10, self.shorthand_btn_10, self.shorthand_s10_btn)
        self.autocomp_btn_10 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w10_btn) 
        self.autocomp_btn_10['command'] = lambda: self.change_shorthand(self.autocomp_entry_10, self.shorthand_w10, self.autocomp_btn_10, self.shorthand_w10_btn)
        ...
        self.shorthand_btn_11['command'] = lambda: self.change_shorthand(self.shorthand_entry_11, self.shorthand_s11, self.shorthand_btn_11, self.shorthand_s11_btn)
        self.autocomp_btn_11 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w11_btn)
        self.autocomp_btn_11['command'] = lambda: self.change_shorthand(self.autocomp_entry_11, self.shorthand_w11, self.autocomp_btn_11, self.shorthand_w11_btn) 
        ...
        self.shorthand_btn_12['command'] = lambda: self.change_shorthand(self.shorthand_entry_12, self.shorthand_s12, self.shorthand_btn_12, self.shorthand_s12_btn)
        self.autocomp_btn_12 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w12_btn)
        self.autocomp_btn_12['command'] = lambda: self.change_shorthand(self.autocomp_entry_12, self.shorthand_w12, self.autocomp_btn_12, self.shorthand_w12_btn) 
        ...
        self.shorthand_btn_13['command'] = lambda: self.change_shorthand(self.shorthand_entry_13, self.shorthand_s13, self.shorthand_btn_13, self.shorthand_s13_btn)
        self.autocomp_btn_13 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w13_btn) 
        self.autocomp_btn_13['command'] = lambda: self.change_shorthand(self.autocomp_entry_13, self.shorthand_w13, self.autocomp_btn_13, self.shorthand_w13_btn)
        ...
        self.shorthand_btn_14['command'] = lambda: self.change_shorthand(self.shorthand_entry_14, self.shorthand_s14, self.shorthand_btn_14, self.shorthand_s14_btn)
        self.autocomp_btn_14 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w14_btn) 
        self.autocomp_btn_14['command'] = lambda: self.change_shorthand(self.autocomp_entry_14, self.shorthand_w14, self.autocomp_btn_14, self.shorthand_w14_btn)
        ...
        self.shorthand_btn_15['command'] = lambda: self.change_shorthand(self.shorthand_entry_15, self.shorthand_s15, self.shorthand_btn_15, self.shorthand_s15_btn)
        self.autocomp_btn_15 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w15_btn) 
        self.autocomp_btn_15['command'] = lambda: self.change_shorthand(self.autocomp_entry_15, self.shorthand_w15, self.autocomp_btn_15, self.shorthand_w15_btn)
        ...
        self.shorthand_btn_16['command'] = lambda: self.change_shorthand(self.shorthand_entry_16, self.shorthand_s16, self.shorthand_btn_16, self.shorthand_s16_btn)
        self.autocomp_btn_16 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w16_btn) 
        self.autocomp_btn_16['command'] = lambda: self.change_shorthand(self.autocomp_entry_16, self.shorthand_w16, self.autocomp_btn_16, self.shorthand_w16_btn)
        ...
        self.shorthand_btn_17['command'] = lambda: self.change_shorthand(self.shorthand_entry_17, self.shorthand_s17, self.shorthand_btn_17, self.shorthand_s17_btn)
        self.autocomp_btn_17 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w17_btn) 
        self.autocomp_btn_17['command'] = lambda: self.change_shorthand(self.autocomp_entry_17, self.shorthand_w17, self.autocomp_btn_17, self.shorthand_w17_btn)
        ...
        self.shorthand_btn_18['command'] = lambda: self.change_shorthand(self.shorthand_entry_18, self.shorthand_s18, self.shorthand_btn_18, self.shorthand_s18_btn)
        self.autocomp_btn_18 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w18_btn) 
        self.autocomp_btn_18['command'] = lambda: self.change_shorthand(self.autocomp_entry_18, self.shorthand_w18, self.autocomp_btn_18, self.shorthand_w18_btn)
        ...
        self.shorthand_btn_19['command'] = lambda: self.change_shorthand(self.shorthand_entry_19, self.shorthand_s19, self.shorthand_btn_19, self.shorthand_s19_btn)
        self.autocomp_btn_19 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w19_btn)
        self.autocomp_btn_19['command'] = lambda: self.change_shorthand(self.autocomp_entry_19, self.shorthand_w19, self.autocomp_btn_19, self.shorthand_w19_btn)
        ...
        self.shorthand_btn_20['command'] = lambda: self.change_shorthand(self.shorthand_entry_20, self.shorthand_s20, self.shorthand_btn_20, self.shorthand_s20_btn)
        self.autocomp_btn_20 = ttk.Button(self.shorthand_tab, textvariable=self.shorthand_w20_btn) 
        self.autocomp_btn_20['command'] = lambda: self.change_shorthand(self.autocomp_entry_20, self.shorthand_w20, self.autocomp_btn_20, self.shorthand_w20_btn) 

    def create_layout(self):
        # General Tab Layout
        self.gen_conflict_notifier.grid(row=0, column=0, columnspan=4, sticky='NW')
        ...
        self.shorthand_entry_1.grid(row=1, column=0, sticky='NW')
        self.shorthand_btn_1.grid(row=1, column=1, sticky='NW')
        self.autocomp_entry_1.grid(row=1, column=2, sticky='NW')
        self.autocomp_btn_1.grid(row=1, column=3, sticky='NW')

        self.shorthand_entry_2.grid(row=2, column=0, sticky='NW')
        self.shorthand_btn_2.grid(row=2, column=1, sticky='NW')
        self.autocomp_entry_2.grid(row=2, column=2, sticky='NW')
        self.autocomp_btn_2.grid(row=2, column=3, sticky='NW')

        self.shorthand_entry_3.grid(row=3, column=0, sticky='NW')
        self.shorthand_btn_3.grid(row=3, column=1, sticky='NW')
        self.autocomp_entry_3.grid(row=3, column=2, sticky='NW')
        self.autocomp_btn_3.grid(row=3, column=3, sticky='NW')

        self.shorthand_entry_4.grid(row=4, column=0, sticky='NW')
        self.shorthand_btn_4.grid(row=4, column=1, sticky='NW')
        self.autocomp_entry_4.grid(row=4, column=2, sticky='NW')
        self.autocomp_btn_4.grid(row=4, column=3, sticky='NW')

        self.shorthand_entry_5.grid(row=5, column=0, sticky='NW')
        self.shorthand_btn_5.grid(row=5, column=1, sticky='NW')
        self.autocomp_entry_5.grid(row=5, column=2, sticky='NW')
        self.autocomp_btn_5.grid(row=5, column=3, sticky='NW')

        self.shorthand_entry_6.grid(row=6, column=0, sticky='NW')
        self.shorthand_btn_6.grid(row=6, column=1, sticky='NW')
        self.autocomp_entry_6.grid(row=6, column=2, sticky='NW')
        self.autocomp_btn_6.grid(row=6, column=3, sticky='NW')

        self.shorthand_entry_7.grid(row=7, column=0, sticky='NW')
        self.shorthand_btn_7.grid(row=7, column=1, sticky='NW')
        self.autocomp_entry_7.grid(row=7, column=2, sticky='NW')
        self.autocomp_btn_7.grid(row=7, column=3, sticky='NW')

        self.shorthand_entry_8.grid(row=8, column=0, sticky='NW')
        self.shorthand_btn_8.grid(row=8, column=1, sticky='NW')
        self.autocomp_entry_8.grid(row=8, column=2, sticky='NW')
        self.autocomp_btn_8.grid(row=8, column=3, sticky='NW')

        self.shorthand_entry_9.grid(row=9, column=0, sticky='NW')
        self.shorthand_btn_9.grid(row=9, column=1, sticky='NW')
        self.autocomp_entry_9.grid(row=9, column=2, sticky='NW')
        self.autocomp_btn_9.grid(row=9, column=3, sticky='NW')

        self.shorthand_entry_10.grid(row=10, column=0, sticky='NW')
        self.shorthand_btn_10.grid(row=10, column=1, sticky='NW')
        self.autocomp_entry_10.grid(row=10, column=2, sticky='NW')
        self.autocomp_btn_10.grid(row=10, column=3, sticky='NW')

        self.shorthand_entry_11.grid(row=11, column=0, sticky='NW')
        self.shorthand_btn_11.grid(row=11, column=1, sticky='NW')
        self.autocomp_entry_11.grid(row=11, column=2, sticky='NW')
        self.autocomp_btn_11.grid(row=11, column=3, sticky='NW')

        self.shorthand_entry_12.grid(row=12, column=0, sticky='NW')
        self.shorthand_btn_12.grid(row=12, column=1, sticky='NW')
        self.autocomp_entry_12.grid(row=12, column=2, sticky='NW')
        self.autocomp_btn_12.grid(row=12, column=3, sticky='NW')

        self.shorthand_entry_13.grid(row=13, column=0, sticky='NW')
        self.shorthand_btn_13.grid(row=13, column=1, sticky='NW')
        self.autocomp_entry_13.grid(row=13, column=2, sticky='NW')
        self.autocomp_btn_13.grid(row=13, column=3, sticky='NW')

        self.shorthand_entry_14.grid(row=14, column=0, sticky='NW')
        self.shorthand_btn_14.grid(row=14, column=1, sticky='NW')
        self.autocomp_entry_14.grid(row=14, column=2, sticky='NW')
        self.autocomp_btn_14.grid(row=14, column=3, sticky='NW')

        self.shorthand_entry_15.grid(row=15, column=0, sticky='NW')
        self.shorthand_btn_15.grid(row=15, column=1, sticky='NW')
        self.autocomp_entry_15.grid(row=15, column=2, sticky='NW')
        self.autocomp_btn_15.grid(row=15, column=3, sticky='NW')

        self.shorthand_entry_16.grid(row=16, column=0, sticky='NW')
        self.shorthand_btn_16.grid(row=16, column=1, sticky='NW')
        self.autocomp_entry_16.grid(row=16, column=2, sticky='NW')
        self.autocomp_btn_16.grid(row=16, column=3, sticky='NW')

        self.shorthand_entry_17.grid(row=17, column=0, sticky='NW')
        self.shorthand_btn_17.grid(row=17, column=1, sticky='NW')
        self.autocomp_entry_17.grid(row=17, column=2, sticky='NW')
        self.autocomp_btn_17.grid(row=17, column=3, sticky='NW')

        self.shorthand_entry_18.grid(row=18, column=0, sticky='NW')
        self.shorthand_btn_18.grid(row=18, column=1, sticky='NW')
        self.autocomp_entry_18.grid(row=18, column=2, sticky='NW')
        self.autocomp_btn_18.grid(row=18, column=3, sticky='NW')

        self.shorthand_entry_19.grid(row=19, column=0, sticky='NW')
        self.shorthand_btn_19.grid(row=19, column=1, sticky='NW')
        self.autocomp_entry_19.grid(row=19, column=2, sticky='NW')
        self.autocomp_btn_19.grid(row=19, column=3, sticky='NW')

        self.shorthand_entry_20.grid(row=20, column=0, sticky='NW')
        self.shorthand_btn_20.grid(row=20, column=1, sticky='NW')
        self.autocomp_entry_20.grid(row=20, column=2, sticky='NW')
        self.autocomp_btn_20.grid(row=20, column=3, sticky='NW')
    ...
    def conflict_checker(self, bind_list):
        ...
        if number_of_conflicts != 0:
            text = "WARNING: There are keybinds that share the same command."
    ...
    def change_shorthand(self, obj, var, btn, btn_var):
        obj['state'] = 'active'
        var.set('')
        btn['command'] = lambda: self.set_shorthand(obj, var, btn, btn_var)
        btn_var.set("Set")
        obj.focus()
    
    def set_shorthand(self, obj, var, btn, btn_var):
        obj['state'] = 'disabled'
        btn['command'] = lambda: self.change_shorthand(obj, var, btn, btn_var)
        btn_var.set("Edit")
        if var.get() == '':
            var.set('...')
